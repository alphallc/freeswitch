...
IUSE_MODULES="alsa amr amrwb +cdr_csv celt cepstral cidlookup cluechoo +console curl dialplan_asterisk dialplan_directory
easyroute erlang_event fax file_string flite +g723_1 g729 h26x iax +ilbc java dingaling lcr ldap +limit +local_stream +logfile +lua
managed memcache nibblebill opal openzap perl pocketsphinx portaudio portaudio_stream python radius_cdr
say_de +say_en say_es say_fr say_it say_nl say_ru say_zh shell_stream shout siren skypiax +sndfile +sofia +speex
spidermonkey spidermonkey_curl spidermonkey_core_db spidermonkey_odbc spidermonkey_socket spidermonkey_teletone spy
+syslog +tone_stream unimrcp vmd +voipcodecs xml_cdr xml_curl xml_ldap xml_rpc yaml zeroconf"
...
MODULES_RDEPEND="
	...
	freeswitch_modules_opal? ( >=net-libs/opal-3.6.4[h323,iax]
				   >=net-libs/ptlib-2.6.2 )
